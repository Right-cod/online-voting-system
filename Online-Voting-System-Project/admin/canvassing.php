    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			...
			<select name="position" id="position" class = "form-control pull-left" style = "width:300px;margin-left:19px; ">
				...
				<option>ICT And academic affirs secretary</option>
				<option>secreatry general </option>
				<option>finance secretary</option>
				<option>organizing secretary</option>
				<option>gender and special needs</option>
				<option>Speaker</option>
				<option>hostel congress person</option>
