				...
				<form method = "post" enctype = "multipart/form-data">	
					<div class="form-group">
						...
						<select class = "form-control" name = "position">
								...
								<option>Deputy preident</option>
								<option>Secretery General</option>
								<option>Finance Secretary</option>
								<option>Organizing Secretary</option>
								<option>ICT and Academic Affairs Secretary</option>
								<option>Gender and Special Needs Secretary</option>
								<option>Sports and Entertainment Secretary</option>
								<option>Speaker</option>
								<option>Deputy Speaker</option>
								<option>Hostel Congresspersons</option>
							</select>
					</div>
